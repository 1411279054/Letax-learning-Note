...
\begin{enumerate}
    ...
    \item 一质点沿X轴运动，当$t=0$时，物体静止于$x=10m$处，若其加速度为$a=4t$(SI制)，则t时刻质点的速度\anl{$2t^2m/s$}, 运动方程\anl{$\frac{2}{3}t^2+10 m$} .
    ...
    \item 一质点沿半径为$0.10m$的圆周运动，其角位置$\theta$（以弧度表示）为$\theta=2+4t^3$,\ $t=2$秒时，法向加速度\anl{$230.4 m/s^2$}; 切向加速度\anl{$4.8 m/s$}; $t = \anl{0.55s}$ 时,切向加速度与法向加速度量值相等 .
